...
layouts_test_fig = px.scatter(x=[0, 1, 2, 3, 4], y=[0, 1, 4, 9, 16])
                ...
                html.Div(
                    ...
                    children=[
                        dcc.Markdown(
                            className="item-markdown",
                            children='''
                            # This is a markdown block! We can fill it with text
                            ## Of
                            ### Various
                            #### Formats
                            Including plain and dynamic text.
                            '''
                        ),
                        dcc.Graph(
                            className='item-plot',
                            figure= layouts_test_fig
                        )
                    ]
                )
            ]
